...
// Modelo de cliente. Mapea la informacion contenida en la tabla Cliente de la base de datos
// Es decir que cada objeto de la clase cliente corresponde a una fila de la tabla cliente. 
...
public class Cliente {
    ...
    public String toString() {
        return "Cliente{" + "idCliente=" + idCliente + ", nombre=" 
